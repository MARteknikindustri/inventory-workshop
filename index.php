...
if($cek > 0){
 ...
 if($data['role']=="admin"){
	...
	header("location:stock/pekerja.php");
...
<html lang="en">
  <head>
    ...
    <title>Anugerah Fajar Rezeki</title>
  ...
  <!-- Global site tag (gtag.js) - Google Analytics -->
	...
	<style>body{background-image:url("bg K.jpg");}
...
h4{font-size:85%;}
  ...
  <img src="logo afr.png" width="25%" style="margin-top:5%" \>
